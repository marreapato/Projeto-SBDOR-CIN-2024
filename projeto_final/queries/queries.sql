...
SELECT H.PKID_HOTEL,H.NOME, DEREF(G.COMPRAS).PASSAGEIROS.NOME, DEREF(G.COMPRAS).PASSAGEIROS.PK_CPF,
DEREF(G.COMPRAS).PASSAGEM.PK_LOCALIZADOR_PASSAGEM FROM HOTEL H,
TABLE(H.REGISTROS) R, TABLE(DEREF(R.ESTADIAS).RESERVAS) G;
