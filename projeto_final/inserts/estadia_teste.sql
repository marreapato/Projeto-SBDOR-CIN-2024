...
INSERT INTO ESTADIA VALUES (
    ESTADIA_TP(
        ...
        TO_DATE('14/01/2025', 'DD/MM/YYYY'),
  		TO_DATE('17/01/2025', 'DD/MM/YYYY'), -- data_check_out
        TP_NT_RESERVA(TP_RESERVA((SELECT REF(pt) FROM compra_tb pt WHERE pt.id_compra = 20)))
    )
);
...
INSERT INTO ESTADIA VALUES (
    ESTADIA_TP(
        ...
        TO_DATE('14/01/2025', 'DD/MM/YYYY'),
  		TO_DATE('17/01/2025', 'DD/MM/YYYY'), -- data_check_out
        TP_NT_RESERVA(TP_RESERVA((SELECT REF(pt) FROM compra_tb pt WHERE pt.id_compra = 10)))
    )
);
